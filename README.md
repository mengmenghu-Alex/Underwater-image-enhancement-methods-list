 ...
 * @LastEditors: 强虎
 * @LastEditTime: 2025-07-04 17:14:26
...
|Underwater Image Enhancement With Reinforcement Learning|IEEE Journal of Oceanic Engineering|[Sun et al., 2022](https://ieeexplore.ieee.org/abstract/document/9751218)|[Github](https://gitee.com/sunshixin_upc/underwater-image-enhancement-with-reinforcement-learning.)|
...
|**CLUIE-Net**(Beyond Single Reference for Training: Underwater Image Enhancement via Comparative Learning)|IEEE Transactions on Circuits and Systems for Video Technology|[Li et al., 2022](https://ieeexplore.ieee.org/abstract/document/9965419/authors#authors)|[Github](https://justwj.github.io/CLUIE-Net.html/.)|
|**MFEF**(Multi-view underwater image enhancement method via embedded fusion mechanism)|Engineering Applications of Artificial Intelligence|[Zhou et al., 2023](https://www.sciencedirect.com/science/article/abs/pii/S0952197623001306)|None|
...
|**PDD-Net**(Perception-Driven Deep Underwater Image Enhancement Without Paired Supervision)|IEEE Transactions on Multimedia|[Jiang et al., 2023](https://ieeexplore.ieee.org/abstract/document/10319078)|None|
|**ReX-Net**(ReX-Net: A reflectance-guided underwater image enhancement network for extreme scenarios)|Expert Systems with Applications|[Zhou et al., 2023](https://www.sciencedirect.com/science/article/abs/pii/S0957417423013441)|None|
|Underwater image enhancement using adaptive standardization and normalization networks|Engineering Applications of Artificial Intelligence|[Park et al., 2024](https://www.sciencedirect.com/science/article/abs/pii/S0952197623016299)|[Github](https://github.com/cwoop92/Underwater-image-enhancement-using-adaptive-standardization-and-normalization-networks)|
...
|**UIEDP**(UIEDP: Boosting underwater image enhancement with diffusion prior)|Expert Systems with Applications|[Du et al., 2025](https://www.sciencedirect.com/science/article/abs/pii/S0957417424021389)|None|
